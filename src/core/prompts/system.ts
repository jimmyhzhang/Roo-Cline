...
export async function addCustomInstructions(
	...
	async function loadRuleFiles(): Promise<string> {
		const ruleFiles = [".clinerules", ".planning", ".scratchpad", ".learnedlessons"]
		let combinedRules = ""
...
- You can access to stock's fundamental data, income statement growth and trailing 12 month financial ratios and traling 12 month key metrics from fetch_financial_data.
- You can use web_search to search the internet for information. e.g which stocks is popular top 10 AI stocks or market environment and news
